          ...
          <div className="flex flex-col items-center w-full justify-center font-rubik">
            <div className="flex flex-col md:flex-row w-full justify-between gap-20">
              <div className="h-full">
                ...
                <div className="flex flex-col mb-4 p-4 sm:flex-row justify-between items-start md:items-center gap-8 bg-stone-100/30 hover:bg-stone-200/30 dark:hover:bg-stone-600/30 transition-all transition-duration-500 hover:-translate-y-1 rounded-lg dark:bg-stone-700/30 backdrop-blur-sm shadow-lg max-w-[600px]">
                  <div>
                    <div className="mb-4 font-roboto">
                      <strong>Melhores Destinos</strong>
                      <br />
                  ...
                  <img
                    ...
                    alt="Logo do Melhores Destinos, fundo azul com um pin de localização em uma lupa, com um avião no meio"
                  />
                </div>
                <div className="flex flex-col mb-4 p-4 sm:flex-row justify-between items-start md:items-center bg-stone-100/30 hover:bg-stone-200/30 dark:hover:bg-stone-600/30 transition-all transition-duration-500 hover:-translate-y-1 rounded-lg dark:bg-stone-700/30 backdrop-blur-sm shadow-lg max-w-[600px]">
                  <div>
                    <div className="mb-4 font-roboto">
                      <strong>
              ...
              <div className="h-full">
                <h1 className="text-2xl md:text-4xl mb-10 font-extrabold font-roboto text-center">
                  Certificados
                </h1>
                <div className="flex flex-col mb-4 p-4 sm:flex-row justify-between items-start md:items-center gap-8 bg-stone-100/30 hover:bg-stone-200/30 dark:hover:bg-stone-600/30 transition-all transition-duration-500 hover:-translate-y-1 rounded-lg dark:bg-stone-700/30 backdrop-blur-sm shadow-lg max-w-[600px]">
                  <div>
                ...
                <div className="flex flex-col mb-4 p-4 sm:flex-row justify-between items-start md:items-center bg-stone-100/30 hover:bg-stone-200/30 dark:hover:bg-stone-600/30 transition-all hover:-translate-y-1 rounded-lg dark:bg-stone-700/30 backdrop-blur-sm shadow-xl max-w-[600px]">
                  <div>
                    <div className="mb-4 font-roboto">
                      <strong>
                        Orc'estra Gamificação
            ...
            <button
              className="w-4/5 mt-10 sm:w-1/2 md:w-3/4 xl:w-1/2 text-center text-lg md:text-xl bg-stone-900 hover:bg-stone-700 focus:outline-none focus:ring-2 focus:ring-stone-400 focus:ring-offset-2 text-white font-semibold h-12 px-6 rounded-lg dark:bg-stone-700 dark:hover:bg-stone-600/30 pointer-events-auto"
              onClick={() => navigate('/')}
            >
              Voltar
            </button>
